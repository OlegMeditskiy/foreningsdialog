                ...
                <div key={idx}>
                    <Card>
                        <Accordion.Toggle as={Card.Header} eventKey={'association' + idx}>
                            Förening {idx + 1}
                            <Button data-organization={organizationId} className={"pull-right"} variant={"danger"}
                                    onClick={(event) => props.remove(event, idx, 'association')}>
                            ...
                            <Card.Body>
                                ...
                                <div className={"contact"}>
                                    ...
                                    <Accordion defaultActiveKey={"0"}>
                                        <ContactInput remove={props.remove} handleChange={props.handleChange}
                                                      errors={props.errors} organization={props.organization}
                                                      association={idx} contacts={props.associations[idx].contacts}/>
                                    </Accordion>
                                </div>
                                <div className={"house"}>
                                    <Accordion defaultActiveKey={"0"}>
                                        ...
                                        <HouseInput remove={props.remove} handleChange={props.handleChange}
                                                    errors={props.errors} organization={props.organization}
                                                    association={idx} houses={props.associations[idx].houses}/>
                                    </Accordion>
                                </div>
                            </Card.Body>
                        </Accordion.Collapse>
